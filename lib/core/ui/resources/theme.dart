...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff576422),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xffdaea99),
      ...
      tertiaryFixed: Color(0xffdaea99),
      onTertiaryFixed: Color(0xff171e00),
      tertiaryFixedDim: Color(0xffbece7f),
      onTertiaryFixedVariant: Color(0xff3f4c0a),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff3b4806),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff6d7b36),
      ...
      tertiaryFixed: Color(0xff6d7b36),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff54621f),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff1d2500),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff3b4806),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff3b4806),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff273000),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffdadbd0),
      surfaceBright: Color(0xfff9faef),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffbece7f),
      onTertiary: Color(0xff2a3400),
      tertiaryContainer: Color(0xff3f4c0a),
      onTertiaryContainer: Color(0xffdaea99),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffc2d283),
      onTertiary: Color(0xff131900),
      tertiaryContainer: Color(0xff89974f),
      ...
      tertiaryFixedDim: Color(0xffbece7f),
      onTertiaryFixedVariant: Color(0xff303b00),
      surfaceDim: Color(0xff12140e),
      surfaceBright: Color(0xff383a32),
      surfaceContainerLowest: Color(0xff0c0f09),
      surfaceContainerLow: Color(0xff1a1c16),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xfff8ffd2),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffc2d283),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixed: Color(0xffdeef9c),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffc2d283),
